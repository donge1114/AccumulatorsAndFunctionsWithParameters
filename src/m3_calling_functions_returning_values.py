...
def main():
    ...
    # ------------------------------------------------------------------
    # DONE: 9. DO THIS LAST!
    # --Uncomment the line of code below to run the main function in
    # m3t_tester.py (do not make changes to it).
...
def run_test_sum_of_digits():
    ...
    # Test 4:
    expected = 18
    answer = sum_of_digits(558)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    # Test 5
    expected = 19
    answer = sum_of_digits(559)
...
def run_test_digits_in_power():
    ...
    # Test2
    expected = 18
    answer = digits_in_power(36, 2)
    print('Test 1 expected:', expected)
    print('       answer:  ', answer)
    # Test3
    expected = 18
    answer = digits_in_power(99, 2)
    print('Test 1 expected:', expected)
    print('       answer:  ', answer)
